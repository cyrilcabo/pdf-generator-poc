...
import { columns, mockData } from './AnnualisedPerformanceTable';
import * as calendarYearData from './CalendarYearPerformanceTable';
import * as holdingsData from './HoldingsTable';
import * as sectorGeographyData from './SectorGeographyTable';
...
const PDFDocument = ({ chartLink, logoSrc }: { chartLink?: string; logoSrc?: string; }) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.topSection}>
          <Image style={styles.amiLogo} src={logoSrc || '/logo.png'} />
